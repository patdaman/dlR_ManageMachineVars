CREATE TABLE [config].[ConfigFileElements] (
    ...
    [parent_element_id] INT           CONSTRAINT [DF_ConfigFileElements_ParentElementId] DEFAULT ((0)) NOT NULL,
    ...
    CONSTRAINT [FK_ConfigFileElements_ConfigFileElements] FOREIGN KEY ([parent_element_id]) REFERENCES [config].[ConfigFileElements] ([id]),
    CONSTRAINT [IX_ConfigFileElements] UNIQUE NONCLUSTERED ([configfile_id] ASC, [element_name] ASC, [parent_element_id] ASC)
);
