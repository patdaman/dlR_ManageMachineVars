...
namespace CommonUtils.DataStructures
{
    ...
    public class BiDictionary<TFirst, TSecond> : IDictionary<TFirst, TSecond>, IReadOnlyDictionary<TFirst, TSecond>, IDictionary
    {
        ...
        void ICollection<KeyValuePair<TFirst, TSecond>>.Add(KeyValuePair<TFirst, TSecond> item)
        {
            ...
            _secondToFirst.Add(ReverseKey(item));
        }

        private  KeyValuePair<TSecond, TFirst> ReverseKey(KeyValuePair<TFirst, TSecond> item)
        {
            KeyValuePair<TSecond, TFirst> revkey = new KeyValuePair<TSecond, TFirst>(item.Value, item.Key);
            return revkey;
        }
        ...
        private class ReverseDictionary : IDictionary<TSecond, TFirst>, IReadOnlyDictionary<TSecond, TFirst>, IDictionary
        {
            ...
            private KeyValuePair<TFirst, TSecond> ReverseKey(KeyValuePair<TSecond, TFirst> item)
            {
                KeyValuePair<TFirst, TSecond> revkey = new KeyValuePair<TFirst, TSecond>(item.Value, item.Key);
                return revkey;
            }
            ...
            void ICollection<KeyValuePair<TSecond, TFirst>>.Add(KeyValuePair<TSecond, TFirst> item)
            {
                ...
                _owner._firstToSecond.Add(ReverseKey(item));
            }
